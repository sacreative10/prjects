...
VulkanEngineDevice::VulkanEngineDevice(VulkanEngineWindow &window) : window{window} {
  createInstance();
  setupDebugMessenger();
  createSurface();
  pickPhysicalDevice();
...
void VulkanEngineDevice::createInstance() {
...
void VulkanEngineDevice::createSurface() { window.createWindowSurface(instance, &surface_); }
...
void VulkanEngineDevice::hasGflwRequiredInstanceExtensions() {
...
VkFormat VulkanEngineDevice::findSupportedFormat(
...
void VulkanEngineDevice::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
